...
void dispatch(void* packed_recv_x, float* packed_recv_x_scales,
    ...
    cudaLaunchConfig_t cfg = {                            \
        (num_sms), (num_warps * 32), 0, stream, nullptr, 0}; \
    ...
    switch (hidden) {
        case 2048: {
            auto dispatch_func = use_fp8 ? dispatch<true, kNumWarpGroups, kNumWarpsPerGroup, 2048> :
                                           dispatch<false, kNumWarpGroups, kNumWarpsPerGroup, 2048>;
            CUDA_CHECK(cudaLaunchKernelEx(&cfg, dispatch_func,
        ...
        case 2560: {
            auto dispatch_func = use_fp8 ? dispatch<true, kNumWarpGroups, kNumWarpsPerGroup, 2560> :
                                           dispatch<false, kNumWarpGroups, kNumWarpsPerGroup, 2560>;
            CUDA_CHECK(cudaLaunchKernelEx(&cfg, dispatch_func,
                  packed_recv_x, packed_recv_x_scales,
                  packed_recv_src_info, packed_recv_layout_range,
                  packed_recv_count, active_ranks,
        ...
        case 3072: {
            auto dispatch_func = use_fp8 ? dispatch<true, kNumWarpGroups, kNumWarpsPerGroup, 3072> :
                                           dispatch<false, kNumWarpGroups, kNumWarpsPerGroup, 3072>;
            CUDA_CHECK(cudaLaunchKernelEx(&cfg, dispatch_func,
                  packed_recv_x, packed_recv_x_scales,
                  packed_recv_src_info, packed_recv_layout_range,
                  packed_recv_count, active_ranks,
        ...
        case 4096: {
            auto dispatch_func = use_fp8 ? dispatch<true, kNumWarpGroups, kNumWarpsPerGroup, 4096> :
                                           dispatch<false, kNumWarpGroups, kNumWarpsPerGroup, 4096>;
            CUDA_CHECK(cudaLaunchKernelEx(&cfg, dispatch_func,
                  packed_recv_x, packed_recv_x_scales,
                  packed_recv_src_info, packed_recv_layout_range,
                  packed_recv_count, active_ranks,
        ...
        case 5120: {
            auto dispatch_func = use_fp8 ? dispatch<true, kNumWarpGroups, kNumWarpsPerGroup, 5120> :
                                           dispatch<false, kNumWarpGroups, kNumWarpsPerGroup, 5120>;
            CUDA_CHECK(cudaLaunchKernelEx(&cfg, dispatch_func,
                  packed_recv_x, packed_recv_x_scales,
                  packed_recv_src_info, packed_recv_layout_range,
                  packed_recv_count, active_ranks,
        ...
        case 6144: {
            auto dispatch_func = use_fp8 ? dispatch<true, kNumWarpGroups, kNumWarpsPerGroup, 6144> :
                                           dispatch<false, kNumWarpGroups, kNumWarpsPerGroup, 6144>;
            CUDA_CHECK(cudaLaunchKernelEx(&cfg, dispatch_func,
                  packed_recv_x, packed_recv_x_scales,
                  packed_recv_src_info, packed_recv_layout_range,
                  packed_recv_count, active_ranks,
        ...
        case 7168: {
            auto dispatch_func = use_fp8 ? dispatch<true, kNumWarpGroups, kNumWarpsPerGroup, 7168> :
                                           dispatch<false, kNumWarpGroups, kNumWarpsPerGroup, 7168>;
            CUDA_CHECK(cudaLaunchKernelEx(&cfg, dispatch_func,
                  packed_recv_x, packed_recv_x_scales,
                  packed_recv_src_info, packed_recv_layout_range,
                  packed_recv_count, active_ranks,
        ...
        case 8192: {
            auto dispatch_func = use_fp8 ? dispatch<true, kNumWarpGroups, kNumWarpsPerGroup, 8192> :
                                           dispatch<false, kNumWarpGroups, kNumWarpsPerGroup, 8192>;
            CUDA_CHECK(cudaLaunchKernelEx(&cfg, dispatch_func,
                  packed_recv_x, packed_recv_x_scales,
                  packed_recv_src_info, packed_recv_layout_range,
                  packed_recv_count, active_ranks,
...
void combine(void* combined_x, int32_t* active_ranks,
    ...
    switch (hidden) {
        case 2048: {
            auto combine_func = combine<kNumWarpGroups, kNumWarpsPerGroup, 2048, kNumMaxTopk>;
            CUDA_CHECK(cudaLaunchKernelEx(&cfg, combine_func,
                  ...
                  next_clean_buffer,
                  atomic_clean_flag,
                  num_combined_tokens, 2048, num_topk,
                  num_max_dispatch_tokens_per_rank,
                  num_experts, rank, num_ranks,
                  timeout_ticks, phases, zero_copy));
        } break;
        case 2560: {
            auto combine_func = combine<kNumWarpGroups, kNumWarpsPerGroup, 2560, kNumMaxTopk>;
            CUDA_CHECK(cudaLaunchKernelEx(&cfg, combine_func,
                  combined_x, active_ranks,
                  mxa_buffer,
                  rdma_send_signal_buffer, rdma_recv_signal_buffer,
                  ...
                  next_clean_buffer,
                  atomic_clean_flag,
                  num_combined_tokens, 2560, num_topk,
                  num_max_dispatch_tokens_per_rank,
                  num_experts, rank, num_ranks,
                  timeout_ticks, phases, zero_copy));
        } break;
        case 3072: {
            auto combine_func = combine<kNumWarpGroups, kNumWarpsPerGroup, 3072, kNumMaxTopk>;
            CUDA_CHECK(cudaLaunchKernelEx(&cfg, combine_func,
                  combined_x, active_ranks,
                  mxa_buffer,
                  rdma_send_signal_buffer, rdma_recv_signal_buffer,
                  ...
                  next_clean_buffer,
                  atomic_clean_flag,
                  num_combined_tokens, 3072, num_topk,
                  num_max_dispatch_tokens_per_rank,
                  num_experts, rank, num_ranks,
                  timeout_ticks, phases, zero_copy));
        } break;
        case 4096: {
            auto combine_func = combine<kNumWarpGroups, kNumWarpsPerGroup, 4096, kNumMaxTopk>;
            CUDA_CHECK(cudaLaunchKernelEx(&cfg, combine_func,
                  combined_x, active_ranks,
                  mxa_buffer,
                  rdma_send_signal_buffer, rdma_recv_signal_buffer,
                  ...
                  next_clean_buffer,
                  atomic_clean_flag,
                  num_combined_tokens, 4096, num_topk,
                  num_max_dispatch_tokens_per_rank,
                  num_experts, rank, num_ranks,
                  timeout_ticks, phases, zero_copy));
        } break;
        case 5120: {
            auto combine_func = combine<kNumWarpGroups, kNumWarpsPerGroup, 5120, kNumMaxTopk>;
            CUDA_CHECK(cudaLaunchKernelEx(&cfg, combine_func,
                  combined_x, active_ranks,
                  mxa_buffer,
                  rdma_send_signal_buffer, rdma_recv_signal_buffer,
                  ...
                  next_clean_buffer,
                  atomic_clean_flag,
                  num_combined_tokens, 5120, num_topk,
                  num_max_dispatch_tokens_per_rank,
                  num_experts, rank, num_ranks,
                  timeout_ticks, phases, zero_copy));
        } break;
        case 6144: {
            auto combine_func = combine<kNumWarpGroups, kNumWarpsPerGroup, 6144, kNumMaxTopk>;
            CUDA_CHECK(cudaLaunchKernelEx(&cfg, combine_func,
                  combined_x, active_ranks,
                  mxa_buffer,
                  rdma_send_signal_buffer, rdma_recv_signal_buffer,
                  ...
                  next_clean_buffer,
                  atomic_clean_flag,
                  num_combined_tokens, 6144, num_topk,
                  num_max_dispatch_tokens_per_rank,
                  num_experts, rank, num_ranks,
                  timeout_ticks, phases, zero_copy));
        } break;
        case 7168: {
            auto combine_func = combine<kNumWarpGroups, kNumWarpsPerGroup, 7168, kNumMaxTopk>;
            CUDA_CHECK(cudaLaunchKernelEx(&cfg, combine_func,
                  combined_x, active_ranks,
                  mxa_buffer,
                  rdma_send_signal_buffer, rdma_recv_signal_buffer,
                  ...
                  next_clean_buffer,
                  atomic_clean_flag,
                  num_combined_tokens, 7168, num_topk,
                  num_max_dispatch_tokens_per_rank,
                  num_experts, rank, num_ranks,
                  timeout_ticks, phases, zero_copy));
        } break;
        case 8192: {
            auto combine_func = combine<kNumWarpGroups, kNumWarpsPerGroup, 8192, kNumMaxTopk>;
            CUDA_CHECK(cudaLaunchKernelEx(&cfg, combine_func,
                  combined_x, active_ranks,
                  mxa_buffer,
                  rdma_send_signal_buffer, rdma_recv_signal_buffer,
                  ...
                  next_clean_buffer,
                  atomic_clean_flag,
                  num_combined_tokens, 8192, num_topk,
                  num_max_dispatch_tokens_per_rank,
                  num_experts, rank, num_ranks,
                  timeout_ticks, phases, zero_copy));
        } break;
...
void dispatch(
    ...
    ep::dispatch(packed_recv_x, packed_recv_x_scales, packed_recv_src_info,
                 ...
                 mxa_buffer, rdma_send_signal_buffer, rdma_recv_signal_buffer,
                 rdma_send_data_buffer, rdma_recv_data_buffer, cuda_counter_buffer,
                 cuda_data_buffer, raddrs, rkeys, qp_devctxs, nvlink_available,
                 ipc_peer_ptrs, x, topk_idx, next_clean_buffer, num_tokens, hidden,
                 num_max_dispatch_tokens_per_rank, num_topk, num_experts, rank,
                 num_ranks, use_fp8, workspace, stream, timeout_ticks, phases);
}
...
void combine(
    ...
    int phases,
    bool zero_copy) {
    ep::combine(combined_x, active_ranks, mxa_buffer, rdma_send_signal_buffer,
                rdma_recv_signal_buffer, rdma_send_data_buffer, rdma_recv_data_buffer,
                cuda_counter_buffer, cuda_data_buffer, raddrs, rkeys, qp_devctxs,
                nvlink_available, ipc_peer_ptrs, x, topk_idx, topk_weights,
                src_info, layout_range, next_clean_buffer, num_combined_tokens,
                hidden, num_max_dispatch_tokens_per_rank, num_topk, num_experts,
                rank, num_ranks, workspace, stream, timeout_ticks, phases, zero_copy);
}
